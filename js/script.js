window.onload = function () {
    ...
    mode_1.addEventListener('click', () =>{
        ...
        position_x = 0
        document.querySelector('#mode_tittle').innerHTML = 'Blast Netowk'
    ...
    document.querySelector('#mode_p').innerHTML = "<iframe width='560' height='315' src='https://www.youtube.com/embed/0dYfMPYhPvQ' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>"
    document.querySelector('#btest').style.opacity = '100%'
    document.querySelector('#modes_t').style.color = 'white'
    mode_3.style.transform = '1.2'
        mode_2.style.marginLeft ='8%'
